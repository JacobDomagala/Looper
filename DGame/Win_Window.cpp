...
Win_Window::Createwindow()
{
   ...
   m_windowHandle = CreateWindowExA(0, "className", "windowName", windowStyle, CW_USEDEFAULT, CW_USEDEFAULT, rect.right - rect.left,
                                    rect.bottom - rect.top, NULL, NULL, m_hInstance, 0);
   GetClientRect(m_windowHandle, &rect);
}

void
Win_Window::SetUpOpenGL()
{
...
glm::vec2
Win_Window::GetCursorScreenPosition()
{
   POINT cursor;
...
glm::vec2
Win_Window::GetCursorNormalized()
{
   POINT tmpCursor;
...
void
Win_Window::Swapwindow()
{
   SwapBuffers(m_hdc);
}

void
Win_Window::ShowError(const std::string& errorMessage, const std::string& errorTitle)
{
