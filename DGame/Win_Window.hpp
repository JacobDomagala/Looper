...
class Win_Window
{
 ...
 public:
   ...
   MainWinProc(HWND hWind, UINT uMsg, WPARAM wParam, LPARAM lParam);
   ...
   void
   ShowError(const std::string& errorMessage, const std::string& errorTitle);
};
